...
class Customlib
{
    ...
    {
        $call_type             = array();
        $call_type['Entrante'] = $this->CI->lang->line('incoming');
        $call_type['Saliente'] = $this->CI->lang->line('outgoing');
        return $call_type;
    }
    ...
    public function subjectType()
    {
        ...
        $subject_type['teórico']    = $this->CI->lang->line('theory');
        $subject_type['práctico'] = $this->CI->lang->line('practical');
    ...
    {
        $gender           = array();
        $gender['Masculino']   = $this->CI->lang->line('male');
        $gender['Femenino'] = $this->CI->lang->line('female');
        return $gender;
    }
    ...
    {
        $status              = array();
        $status['Lunes']    = $this->CI->lang->line('monday');
        $status['Martes']   = $this->CI->lang->line('tuesday');
        $status['Miércoles'] = $this->CI->lang->line('wednesday');
        $status['Jueves']  = $this->CI->lang->line('thursday');
        $status['Viernes']    = $this->CI->lang->line('friday');
        $status['Sábado']  = $this->CI->lang->line('saturday');
        $status['Domingo']    = $this->CI->lang->line('sunday');
        return $status;
    }
