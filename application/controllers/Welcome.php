...
class Welcome extends Front_Controller
{
    ...
    public function admission()
    {
        ...
        $this->data['active_menu'] = 'home';
        $page                      = array('title' => 'Admisión en línea', 'meta_title' => 'online admission form', 'meta_keyword' => 'online admission form', 'meta_description' => 'online admission form');
