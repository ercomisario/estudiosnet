<aside class="main-sidebar" id="alert2">
                    ...
                    <li class="treeview <?php echo set_Topmenu('Student Information'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('online_admission', 'can_view')) { ?>
                                ...
                                <li class="<?php echo set_Submenu('onlinestudent'); ?>"><a href="<?php echo site_url('admin/onlinestudent'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('admission') . " " . $this->lang->line('online'); ?></a></li>
                            ...
                            if($this->rbac->hasPrivilege('student','can_delete')){
                                ?>
                                <li class="<?php echo set_Submenu('bulkdelete'); ?>"><a href="<?php echo site_url('student/bulkdelete'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('delete') . " " . $this->lang->line('student'); ?></a>
                            </li>
                                <?php
                            }
                            ...
                            if($this->rbac->hasPrivilege('disable_reason','can_view')){
                                ?>
                                 <li class="<?php echo set_Submenu('student/disable_reason'); ?>"><a href="<?php echo base_url(); ?>admin/disable_reason"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('reason') . " " . $this->lang->line('disable'); ?></a></li>
                                <?php
                            }
                            ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('Fees Collection'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if($this->rbac->hasPrivilege('fees_reminder','can_view')){
                                ?>
                                <li class="<?php echo set_Submenu('feereminder/setting'); ?>"><a href="<?php echo site_url('admin/feereminder/setting'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('reminder') . " " . $this->lang->line('fees'); ?></a></li>
                                <?php
                            }
                            ?>
 ...
 <li class="treeview <?php echo set_Topmenu('Online_Examinations'); ?>">
                        <a href="#">
                            <i class="fa fa-rss ftlayer"></i> <span><?php echo $this->lang->line('examinations')." ".$this->lang->line('online'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                          <?php
                          ...
                          if($this->rbac->hasPrivilege('online_examination','can_view')){
                            ?>
                            <li class="<?php echo set_Submenu('Online_Examinations/Onlineexam'); ?>"><a href="<?php echo base_url(); ?>admin/onlineexam"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('exam') . " " . $this->lang->line('online'); ?></a></li>
                            <?php
                          }
                          if($this->rbac->hasPrivilege('question_bank','can_view')){
                            ?>
                              <li class="<?php echo set_Submenu('Online_Examinations/question'); ?>"><a href="<?php echo base_url(); ?>admin/question"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('bank')." ".$this->lang->line('question'); ?></a></li>
                            <?php
                          }
                          ?>  
                    ...
                    <li class="treeview <?php echo set_Topmenu('Academics'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('teachers_time_table', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('Academics/timetable/mytimetable'); ?>"><a href="<?php echo base_url(); ?>admin/timetable/mytimetable"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('timetable')." ".$this->lang->line('teachers')?></a></li>
                                <?php
                            }
                    ...
                    <li class="treeview <?php echo set_Topmenu('Reports'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if($this->module_lib->hasActive('online_examination')){
                                ...
                                ?>
                                 <li class="<?php echo set_Submenu('Reports/online_examinations'); ?>"><a href="<?php echo base_url(); ?>admin/onlineexam/report"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('examinations')." ".$this->lang->line('online'); ?></a></li>
                                <?php
                            }}
                            if($this->module_lib->hasActive('human_resource')){
 ...
 if($this->module_lib->hasActive('hostel')){
                            ...
                            if ($this->rbac->hasPrivilege('audit_trail_report', 'can_view')) {
                                ...
                                <li class="<?php echo set_Submenu('audit/index'); ?>"><a href="<?php echo base_url(); ?>admin/audit"><i class="fa fa-angle-double-right"></i>
                                        <?php echo $this->lang->line('trail') . " " . $this->lang->line('audit'); ?></a></li>
                                <?php
                            }
                    ...
                    <li class="treeview <?php echo set_Topmenu('System Settings'); ?>">
                        ...
                        <ul class="treeview-menu">
                           ...
                           if ($this->rbac->hasPrivilege('custom_fields','can_view')) {
                                ?>
                            <li class="<?php echo set_Submenu('System Settings/customfield'); ?>"><a href="<?php echo base_url(); ?>admin/customfield"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('fields') . " " . $this->lang->line('custom'); ?></a></li>
                        <?php } if($this->rbac->hasPrivilege('system_fields','can_view')){
                            ?>
                            <li class="<?php echo set_Submenu('System Settings/systemfield'); ?>"><a href="<?php echo base_url(); ?>admin/systemfield"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('fields') . " " . $this->lang->line('system'); ?></a></li>
                            <?php
                        }?>
