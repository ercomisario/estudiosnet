                ...
                <div class="box removeboxmius">
                    <div class="box-header ptbnull"></div>
                      <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('report')." ".$this->lang->line('issue_return')." ".$this->lang->line('book'); ?></h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
                            <div class="download_label"><?php echo $this->lang->line('report')." ".$this->lang->line('issue_return')." ".$this->lang->line('book'); ?></div>
