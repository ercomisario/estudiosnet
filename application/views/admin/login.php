...
<html lang="en">
    <head>
        ...
        <title>Administrador : <?php  echo $name; ?></title>
        <!--favican-->
     ...
     <style type="text/css">
       ...
       .bgoffsetbgno{background: transparent; border-right:0 !important; box-shadow: 0px 0px 12px rgba(0, 0, 0, 0.29); border-radius: 10px;}
        .loginradius{border-radius: 10px;} 
                    ...
                    if(empty($notice)){
                      ...
                      <div class="<?php echo $bgoffsetbg; ?>">   
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 nopadding <?php echo $bgoffsetbgno; ?> <?php echo $offset; ?>">
                            <div class="<?php echo $loginbg; ?> loginradius login390">  
                                <div class="form-top">
...
?>
 <!-- <div class="col-lg-1 col-sm-1"><div class="separatline"></div></div>  -->
                        <div class="col-lg-7 col-sm-offset-1 col-sm-12" style="background: #fff9; border-radius: 10px;">
