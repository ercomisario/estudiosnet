                                        ...
                                        foreach ($ReceiveList as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right">
                                                    ...
                                                    <a data-placement="left" onclick="getRecord(<?php echo $value->id; ?>)" class="btn btn-default btn-xs" data-target="#receviedetails" data-toggle="modal"  title="Vista"><i class="fa fa-reorder"></i></a>
