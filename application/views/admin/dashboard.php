      ...
      if($this->rbac->hasPrivilege('conveted_leads_widegts','can_view')){
          ...
          <div class="row">
                      ...
                      <div class="col-lg-7 col-md-7 col-sm-12 col60">
                                ...
                                <div class="box box-primary borderwhite">
                                    <div class="box-header with-border">
                                        <h3 class="box-title"><?php echo $this->lang->line('fees_collection_&_expenses_for'); ?><?php echo $this->lang->line('_expenses_for')?> <?php echo $this->lang->line($month). " " . date('Y'); ?></h3>
            ...
            <div class="col-lg-5 col-md-5 col-sm-12 col40">
              ...
              <div class="box box-primary borderwhite">
                <div class="box-header with-border"><h3 class="box-title"><?php echo $this->lang->line('income')." - ".$this->lang->line($month).' '.date('Y'); ?></h3></div>
           ...
           <div class="row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-12 col40">
              <div class="box box-primary borderwhite">
                <div class="box-header with-border"><h3 class="box-title"><?php echo $this->lang->line('expense')." - ".$this->lang->line($month).' '.date('Y'); ?></h3>
                  </div><!--./info-box--> 
