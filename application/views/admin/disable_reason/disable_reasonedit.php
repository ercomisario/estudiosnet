                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-users"></i> <?php echo $this->lang->line('edit')." ".$this->lang->line('reason')." ".$this->lang->line('disable'); ?></h3>
                        </div> 
            ...
            ?>">             
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                         <h3 class="box-title"><i class="fa fa-users"></i> <?php echo $this->lang->line('list')." ".$this->lang->line('reason')." ".$this->lang->line('disable'); ?></h3>                
                    </div>
                    <div class="box-body">
