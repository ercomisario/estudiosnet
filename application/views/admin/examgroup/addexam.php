            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"> <?php echo $this->lang->line('list') . " " . $this->lang->line('exam'); ?></h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row pb10">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-12 col-xs-6">
                                <p class="examinfo"><span> <?php echo $this->lang->line('type') . " " . $this->lang->line('exam') ?></span> <?php echo $examType[$examgroup->exam_type]; ?></p>
                            </div><!--./col-lg-4-->
