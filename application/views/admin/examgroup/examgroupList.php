                        ...
                        <form id="form1" action="<?php echo site_url('admin/examgroup') ?>"  id="examgroupform" name="examgroupform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label for="exampleInputEmail1"> <?php echo $this->lang->line('type')." ".$this->lang->line('exam')?></label> <small class="req">*</small>
            ...
            ?>">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"> <?php echo $this->lang->line('list')." ".$this->lang->line('exam')." ".$this->lang->line('group')?></h3>
                        <div class="box-tools pull-right">
                        </div><!-- /.box-tools -->
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="mailbox-messages table-responsive">
                            <div class="download_label"> <?php echo $this->lang->line('list')." ".$this->lang->line('exam')." ".$this->lang->line('group')?></div>
                            <table class="table table-hover table-striped table-bordered example">
                                <thead>
                                    <tr>
                                        <th><?php echo $this->lang->line('name'); ?></th>
                                        <th><?php echo $this->lang->line('no')." ".$this->lang->line('of')." ".$this->lang->line('exams'); ?></th>
                                        <th><?php echo $this->lang->line('type')." ".$this->lang->line('exam'); ?></th>
