                    ...
                    <form id="form1" action="<?php echo site_url('admin/staff/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="alert alert-info">                                
                                El correo electrónico del personal, es su nombre de usuario de inicio de sesión, la contraseña se genera automáticamente y se le envía al correo electrónico. El Superadmin puede cambiar la contraseña del personal en la página de perfil del personal.
                            </div>
                            <div class="tshadow mb25 bozero">    
                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('email'); ?> (<?php echo $this->lang->line('user') . " " . $this->lang->line('login'); ?>)</label><small class="req"> *</small>
