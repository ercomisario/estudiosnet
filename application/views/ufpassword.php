    ...
    <body>
        ...
        <div class="top-content">
            <div class="inner-bg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 col-md-offset-4 col-sm-12 nopadding col-md-4">
                           <div class=""> 
                            <div class="loginbg">
                                <div class="form-top">
                                ...
                                <div class="form-bottom">
                                    ...
                                    <form class="" action="<?php echo site_url('site/ufpassword') ?>" method="post">
                                        ...
                                        <button type="submit" class="btn" style="background: #222533;"><?php echo $this->lang->line('submit'); ?></button>
                                    </form>
