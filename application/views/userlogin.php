...
<html lang="en">
    <head>
        ...
        <title>Usuarios : <?php echo $name; ?></title>
       <link href="<?php echo base_url(); ?>uploads/school_content/admin_small_logo/<?php $this->setting_model->getAdminsmalllogo();?>" rel="shortcut icon" type="image/x-icon">
        ...
        <style type="text/css">
            body{
                ...
                background: url('<?php echo base_url(); ?>backend/images/login.jpg') no-repeat center top;
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 nopadding <?php echo $bgoffsetbgno; ?> <?php echo $offset; ?>">
                            ...
                            <div class="form-bottom">
                                ...
                                <form action="<?php echo site_url('site/userlogin') ?>" method="post">
                                    ...
                                    <button type="submit" class="btn" style="background: #222533;">
...
?>
                      ...
                      <div class="col-lg-7 col-sm-offset-1 col-sm-12" style="border-radius: 10px; background:#fff9">
