                    ...
                    <div class="box-header ptbnull"></div>
                     ...
                     <form role="form" action="<?php echo site_url('report/studentbookissuereport') ?>" method="post" class="">
                        <div class="box-body row">
                            ...
                            <?php echo $this->customlib->getCSRF(); ?>
                             ...
                             <div class="col-sm-6 col-md-6">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('type') . " " . $this->lang->line('search'); ?></label>
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('type') . " " . $this->lang->line('members'); ?></label>
            ...
            <div class="">
               <div class="box-header ptbnull"></div>   
                <div class="box-header ptbnull">
                    <h3 class="box-title titlefix"><i class="fa fa-money"></i> <?php echo $this->lang->line('report')." ".$this->lang->line('student')." ".$this->lang->line('issue')." ".$this->lang->line('book'); ?></h3>
                </div>
                <div class="box-body table-responsive">
                 <div class="download_label"><?php echo $this->lang->line('report')." ".$this->lang->line('student')." ".$this->lang->line('issue')." ".$this->lang->line('book')." ".$this->lang->line('from')."<br>";$this->customlib->get_postmessage(); ?> </div>
                    <table class="table table-striped table-bordered table-hover example">
                       <thead>
                                        ...
                                        <th><?php echo $this->lang->line('return_date')." ".$this->lang->line('due'); ?></th>
                                       ...
                                       <th><?php echo $this->lang->line('issue')." ".$this->lang->line('by'); ?></th>
                                        <th><?php echo $this->lang->line('type')." ".$this->lang->line('members'); ?></th>
                                    </tr>
                                    </thead>
                           <tbody>
                                        <?php
