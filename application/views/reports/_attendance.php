        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="box-title"><i class="fa fa-search"></i>  <?php echo $this->lang->line('report')." ".$this->lang->line('attendance')?></h3>
                    ...
                    <div class="">
                       ...
                       if (!is_subAttendence()) { 
                            ...
                            if($this->rbac->hasPrivilege('student_attendance_type_report','can_view')){
                              ?>
                              <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/attendence/attendancereport'); ?>"><a href="<?php echo base_url() ?>report/attendancereport"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('report')." ".$this->lang->line('attendance')." ".$this->lang->line('type')." ".$this->lang->line('student'); ?></a></li>
                              <?php
                            }
                            }
