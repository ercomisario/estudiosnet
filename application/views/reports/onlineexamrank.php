...
?>
            ...
            <div class="">
                ...
                <div class="box-header ptbnull">
                    <h3 class="box-title titlefix"><i class="fa fa-money"></i> <?php echo $this->lang->line('report')." ".$this->lang->line('exam')." ".$this->lang->line('online')." ".$this->lang->line('rank'); ?></h3>
                </div>
                     ...
                     <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('answer')." ".$this->lang->line('correct') ?></th>
                                        <th><?php echo $this->lang->line('answer')." ".$this->lang->line('incorrect') ?></th>
