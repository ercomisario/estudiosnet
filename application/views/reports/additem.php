        ...
        <div class="row">
            ...
            <div class="">
                ...
                <div class="box-header ptbnull">
                    <h3 class="box-title titlefix"><i class="fa fa-money"></i> <?php echo $this->lang->line('report')." ".$this->lang->line('item')." ".$this->lang->line('add'); ?></h3>
                </div>
                <div class="box-body">
                 <div class="download_label"> <?php echo $this->lang->line('report')." ".$this->lang->line('item')." ".$this->lang->line('add')."<br>";$this->customlib->get_postmessage(); ?></div>
                     <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                     <tr>
                                        ...
                                        <th><?php echo $this->lang->line('price')." ".$this->lang->line('purchase'); ?></th>
