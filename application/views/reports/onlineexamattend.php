        ...
        <div class="row">
                    ...
                    <div class="box-header ptbnull"></div>
                     ...
                     <form role="form" action="<?php echo site_url('report/onlineexamattend') ?>" method="post" class="">
                        <div class="box-body row">
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('type') . " " . $this->lang->line('date'); ?></label>
            ...
            <div class="">
                ...
                <div class="box-header ptbnull">
                    <h3 class="box-title titlefix"><i class="fa fa-money"></i> <?php echo $this->lang->line('report')." ".$this->lang->line('attempt')." ".$this->lang->line('exam')." ".$this->lang->line('online'); ?></h3>
                </div>
                <div class="box-body table-responsive" id="subject_list">
                 <div class="download_label"> <?php echo $this->lang->line('report')." ".$this->lang->line('attempt')." ".$this->lang->line('exam')." ".$this->lang->line('online')."<br>";$this->customlib->get_postmessage(); ?></div>
                     ...
                     <table class="table table-striped table-bordered table-hover " id="headerTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text text-center"><?php  echo $this->lang->line('publish')." ".$this->lang->line('exam')?></th>
