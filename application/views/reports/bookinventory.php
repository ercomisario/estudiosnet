            ...
            <div class="">
              <div class="box-header ptbnull"></div>  
                <div class="box-header ptbnull">
                    <h3 class="box-title titlefix"><i class="fa fa-money"></i> <?php echo $this->lang->line('report')." ".$this->lang->line('inventory')." ".$this->lang->line('book'); ?></h3>
                </div>
                <div class="box-body table-responsive">
                 <div class="download_label"> <?php echo $this->lang->line('report')." ".$this->lang->line('inventory')." ".$this->lang->line('book')."<br>";$this->customlib->get_postmessage(); ?> </div>
