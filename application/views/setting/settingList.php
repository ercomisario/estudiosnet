                        ...
                        <form role="form" id="schsetting_form" action="<?php //echo site_url('schsettings/ajax_schedit_new')    ?>" class="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="settinghr"></div>
                                        <h4 class="session-head"><?php echo $this->lang->line('type') . " " . $this->lang->line('attendence'); ?></h4>
                                    </div><!--./col-md-12-->
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-6"> <?php echo $this->lang->line('attendance')." ".$this->lang->line('biometric'); ?></label>
                                            <div class="col-sm-6">
                                                <label class="radio-inline">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4"><?php echo $this->lang->line('admission') . " " . $this->lang->line('online'); ?></label>
                                            <div class="col-sm-8">
                                                <label class="radio-inline">
